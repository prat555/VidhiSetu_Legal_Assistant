...
import { ChatSession } from '../lib/userStorage';
import { MessageSquare, Plus, Trash2, X, Home } from 'lucide-react';
      ...
      <div className="w-72 h-full flex flex-col">
        ...
        <div className="p-4 pb-3 border-b border-zinc-200 dark:border-zinc-800">
          <div className="flex items-center justify-between">
            <Link
              href="/"
              className="flex items-center gap-2 px-3 py-2 bg-zinc-800/80 border border-zinc-700 rounded-lg text-zinc-300 hover:text-white text-sm font-medium transition-all"
            >
